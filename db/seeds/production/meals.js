...
exports.seed = function(knex, Promise) {
  return knex.raw(`TRUNCATE meals RESTART IDENTITY`).then(() => {
    return Promise.all([
      ...
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Breakfast", 1, 5, new Date ]),
      ...
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Lunch", 3, 6, new Date ]),
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Dinner", 2, 6, new Date ]),
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Breakfast", 1, 6, new Date ]),
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Snacks", 4, 6, new Date ]),
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Lunch", 3, 5, new Date ]),
      knex.raw('INSERT INTO meals (name, food_id, diary_id, created_at) VALUES(?,?,?,?)', ["Lunch", 4, 5, new Date ]),
